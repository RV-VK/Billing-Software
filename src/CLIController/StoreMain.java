                    ...
                    switch(operationString)
                    {
                        case "create":
                            ...
                            if (arguments.length != 1 || !arguments[0].equals("product create help")) {
                                if(arguments.length==1&&arguments[0].equals("product create"))
                                {
                                    System.out.print("> ");
                        ...
                        case "list":
                            ...
                            if (commandlet.length != 3 || !commandlet[2].equals("help")) {
                                if(commandlet.length==2)
                                {
                                     resultList=listService.listProductService(listAttributesMap);
                                     for(Product resultProduct:resultList)
                                     {
                                         System.out.println(">> id: " + resultProduct.getId() + ", code: " + resultProduct.getCode() + ", name: " + resultProduct.getName() + ", type: " + resultProduct.getType() + ", unitcode: " + resultProduct.getCode() + ", quantity: " + resultProduct.getAvailableQuantity() + ", price: " + resultProduct.getPrice() + ", costprice: " + resultProduct.getCostPrice());
                                     }
                                     break;
                                }
                        ...
                        case "edit":
                            ...
                            if (arguments.length != 1 || !arguments[0].equals("product edit help")) {
                                if(arguments.length==1&&arguments[0].equals("product edit"))
                                {
                                    System.out.print("> ");
                                    String paramaters=scanner.nextLine();
                                    String[] productAttributes=paramaters.split("\\,");
                        ...
                        case "delete":
                            ...
                            if (commandlet.length != 3) {
                                if(commandlet.length==4 && commandlet[2].equals("-c"))
                                {
