...
public class ProductServiceImplementation implements ProductService {
  ...
  public int editProductService(HashMap<String, String> attributeMap)
      throws SQLException,
    ...
    if (attributeMap.get("name") != null && !attributeMap.get("name").matches(nameRegex)
        || attributeMap.get("code") != null && !attributeMap.get("code").matches(procodeRegex)
        || attributeMap.get("type") != null && !attributeMap.get("type").matches(nameRegex)
        || attributeMap.get("price") != null && !attributeMap.get("price").matches(numberRegex)) {
      return 0;
    }
    boolean status;
    int updateCount = 0;
