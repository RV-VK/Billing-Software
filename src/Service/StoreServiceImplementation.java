...
public class StoreServiceImplementation implements StoreService {
  ...
  {
    if(!store.getName().matches(NAME_REGEX)||!String.valueOf(store.getPhoneNumber()).matches(PHONE_NUMBER_REGEX)||!String.valueOf(store.getGstCode()).matches(GST_NUMBER_REGEX))
      return true;
    else
      return false;
  }
