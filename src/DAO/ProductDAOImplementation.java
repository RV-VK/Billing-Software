...
public class ProductDAOImplementation implements ProductDAO {
  ...
  public Product create(Product product)
    ...
    Product product1= productMapper.create(product);
    sqlSession.commit();
    sqlSession.close();
    return product1;
...
//      productCreateStatement.setFloat(6, product.getStock());
...
//    }
    ...
    sqlSession=sqlSessionFactory.openSession();
    productMapper=sqlSession.getMapper(ProductDAO.class);
    int rowsAffected=productMapper.updateStock(code,stock);
    sqlSession.commit();
    sqlSession.close();
    return rowsAffected;
  }
...
//    }
    ...
    sqlSession=sqlSessionFactory.openSession();
    productMapper=sqlSession.getMapper(ProductDAO.class);
    int rowsAffected=productMapper.updatePrice(code,price);
    sqlSession.commit();
    sqlSession.close();
    return rowsAffected;
  }
