...
public class PurchaseDAOImplementation implements PurchaseDAO {
  ...
  public Purchase create(Purchase purchase) throws ApplicationErrorException, SQLException {
    try {
      ...
      PreparedStatement stockUpdateStatement = purchaseConnection.prepareStatement(stockUpdateQuery);
      PreparedStatement purchaseEntryStatement = purchaseConnection.prepareStatement(purchaseEntryQuery);
      PreparedStatement productNameStatement = purchaseConnection.prepareStatement(productNameQuery);
      ...
      PreparedStatement purchaseItemInsertStatement = purchaseConnection.prepareStatement(purchaseItemInsertQuery);
  ...
  public List list(String attribute, String searchText, int pageLength, int offset) throws ApplicationErrorException {
    ...
    try {
      String listQuery = "SELECT * FROM PURCHASE WHERE " + attribute + "= COALESCE(?," + attribute + ")" + " ORDER BY ID LIMIT " + pageLength + "  OFFSET " + offset;
      ...
      } else if(attribute.equals("id") || attribute.equals("grandtotal")||attribute.equals("invoice")) {
